...
const navItems = [
  ...
  { to: "/admin/recipes",  icon: "📋",  label: "Recipes"    },
  { to: "/admin/chefs",    icon: "👨‍🍳",  label: "Chefs"      },
    ...
    <div className="app-shell">
      ...
      <aside className="sidebar">
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: "0.78rem", fontWeight: 600, color: "var(--accent)" }}>Admin</div>
            <div style={{ fontSize: "0.72rem", color: "var(--text-muted)" }}>{profile?.name || "Admin"}</div>
          </div>
        </div>
